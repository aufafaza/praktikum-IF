public class DigitalClock {
    ...
    public DigitalClock(int hour, int minute, int second) {
        ...
        // TODO:
        // Validasi kembali objek yang sudah terbentuk untuk class invariant. Keluarkan
        // "Invalid clock state after constructor" jika tidak valid
    ...
    public void tick() {
        ...
        // Validasi kembali objek yang sudah diedit untuk class invariant. Keluarkan
        // "Invalid clock state after tick" jika tidak valid
        addOneSecond();
    ...
    public void addSeconds(int seconds) {
        // TODO:
        // seconds harus >= 0.
        // Validasi parameter masukan method dan keluarkan "seconds must be
        // non-negative" jika tidak valid
        // Tambahkan waktu sebanyak seconds detik.
        // Validasi kembali objek yang sudah diedit untuk class invariant. Keluarkan
        // "Invalid clock state after addSeconds" jika tidak valid
        if (seconds < 0) {
    ...
    public void setMode(String modeName) {
        ...
        // Validasi parameter masukan method dan keluarkan "modeName cannot be null"
        // atau "Invalid mode"
        // set mode sesuai modeName
        // Validasi kembali objek yang sudah diedit untuk class invariant. Keluarkan
        // "Mode should never be null" jika tidak valid
        if (modeName == null) {
        ...
        switch (modeName) {
            case "NORMAL":
                ...
                break;
            case "COMPACT":
                this.mode = TimeMode.COMPACT;
                break;
            case "VERBOSE":
                this.mode = TimeMode.VERBOSE;
                break;
            default:
    ...
    public String format() {
        ...
        // kalian harus mengasumsikan DigitalClock dalam mode NORMAL atau COMPACT ketika
        ...
        switch (mode) {
            ...
            case COMPACT:
                return String.format("%02d%02d%02d", hour, minute, second);
            default:
                assert false : "Invalid mode for format";
                return "";
        }
    }
    ...
    private void addOneSecond() {
        // TODO:
        // Lakukan validasi precondition, kalau state tidak valid keluarkan
        // "Precondition failed before addOneSecond"
        ...
        // TODO:
        // Lakukan validasi postcondition state setelah menambahkan. Jika tidak valid
        // keluarkan "Postcondition failed after addOneSecond"
