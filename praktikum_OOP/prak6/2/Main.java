...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < T; i++) {
            int windowsThisThread = baseWindow + (i < remainder ? 1 : 0);
            int currentEnd = currentStart + windowsThisThread;

            WindowThread worker = new WindowThread(A, sums, currentStart, currentEnd, W, i, logs);
        ...
        // Bagi window berurutan ke dalam T threads sedemikian rupa sehingga selisih
        // jumlah window antar thread <= 1.
        // Jika M tidak habis dibagi T, maka thread dengan indeks lebih kecil akan
        // mendapatkan 1 window ekstra.
        // Contoh:
        // N = 8
